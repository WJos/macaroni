  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>En cours <div wire:offline class="badge-warning">(Hors ligne)</div></h1>
          </div>
          <div class="col-sm-6">
                    ...
                    <!-- /.row -->
                        ...
                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="file" wire:model="file" class="form-control @error('file') is-invalid @enderror" autocomplete="off">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                @endif --}}
                {{-- <button wire:click="export()" class="btn btn-sm btn-warning" title="Export Excel"><i class="fas fa-excel"></i></button> --}}
