...
class EnregLivewire extends Component
{
    ...
    public function store(){
        ...
        public function valide($id){
            ...
            DB::table('enregs')
                ->where('enreg_id', $id)
                ->update(['statut' => 'V', 'online' => 0]);
            // DB::table('enregs')->updateOrInsert(['enreg_id' => $id], $enreg);
            // $enreg = Enreg::find($id);
            // $enreg->statut = 'V';
            // $enreg->online = '0';
            // $enreg->save();
        ...
        public function export()
        {
            ...
            // Excel::import(new EnregsImport, $this->file);string $searchTerm, string $client_fliter, string $dDebut, string $dFin
            return (new EnregsExport($searchData, $searchClient, $dtDebut, $dtFin))->download('invoices.xlsx');
